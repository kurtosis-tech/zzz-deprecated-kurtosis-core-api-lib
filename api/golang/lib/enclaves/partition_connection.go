...
// PartitionConnection To get an instance of this type, use the NewUnblockedPartitionConnection, NewBlockedPartitionConnection, etc. functions
type PartitionConnection interface {
	getPartitionConnectionInfo() *kurtosis_core_rpc_api_bindings.PartitionConnectionInfo
}

// ====================================================================================================
//                                    Unblocked Partition Connection
// ====================================================================================================
...
func (connection *partitionConnection) getPartitionConnectionInfo() *kurtosis_core_rpc_api_bindings.PartitionConnectionInfo {
	partitionConnectionInfo := &kurtosis_core_rpc_api_bindings.PartitionConnectionInfo{
